...
var RouteMap = (function() {
  ...
  /**
   * Event called before model is populated. Overwrite this using RouteMap.prototype.extend({}) to apply your own handler.
   * @public
   * @param req
   * @param res
   * @param next
  ...
  /**
   * Function called on GET, PATCH, DELETE requests after the model has been retrieved from the database. The model is accessible in the response object as `res.model`, and can be modified as required. Overwrite this method with RouteMap.prototype.extend()
   * @param req
   * @param res
   * @param next
   * @returns {*}
  ...
  /**
   * Hook called on DELETE requests after the model has been removed from the database. Can be overwritten with RouteMap.prototype.extend() 
   * @param req
   * @param res
   * @param next
   * @returns {*}
  ...
  /**
   * Private hook that sends the actual response, but only if the `res.errors` array is empty. Otherwise exits out of the event loop. This method cannot be overwritten with RouteMap.prototype.extend()
   * @private
   * @param req
   * @param res
   * @param next
